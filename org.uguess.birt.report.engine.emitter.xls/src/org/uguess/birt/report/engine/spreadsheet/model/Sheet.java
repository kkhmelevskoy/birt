...
public interface Sheet extends Block
{
	 ...
	 *            Row index.
	 * @param create
	 *            If this is true, a new row object will be created if it's not
	 *            already existing.
	 * @return
	 */
	 ...
	 *            Column index.
	 * @param create
	 *            If this is true, a new column object will be created if it's
	 ...
	 * @param col
	 * @param create
	 *            If this is true, a new cell will be created if it's not
	 *            already existing.
	 * @return
	 */
