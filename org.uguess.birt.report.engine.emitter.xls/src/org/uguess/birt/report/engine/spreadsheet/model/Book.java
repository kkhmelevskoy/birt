...
public interface Book extends Block
{
	 ...
	 * 
	 * @param anchor
	 *            the existing sheet object or the existing sheet name or an
	...
	/**
	 * @param index
	 *            could be a sheet name or sheet index.
	 * @return
	 */
	...
	/**
	 * @param sheet
	 *            could be a Sheet object, or sheet name, or sheet index.
	 * @return
	 */
