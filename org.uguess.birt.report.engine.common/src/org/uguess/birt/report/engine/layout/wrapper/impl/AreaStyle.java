...
public final class AreaStyle implements Style
{
	...
	private static BoxStyle checkEmpty( BoxStyle bs )
	{
		...
		if ( bs != null )
		{
			if ( bs.getBackgroundColor( ) == null
					...
					&& bs.getBottomBorder( ) == null
					&& bs.getTopBorder( ) == null
					&& bs.getLeftBorder( ) == null
					&& bs.getRightBorder( ) == null )
			{
				return null;
			}
		}
	...
	AreaStyle( BoxStyle box, TextStyle text )
	{
		this.box = box;
		this.text = text;
	}
